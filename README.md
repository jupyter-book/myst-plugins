...
|---|---|---|---|---|---|---|
| page-last-updated | A plugin that automatically slots in the latest update date per page | transform | requires to set fetch depth in deploy.yml `fetch-depth: 0` | tested | Freek Pols | [Link]([https://github.com/jupyter-book/myst-plugins/releases/download/page-last-updated/page-last-updated.mjs](https://github.com/jupyter-book/myst-plugins/releases/download/page-last-updatedv1.1/page-last-updated.mjs)) | 
